...
genome_parameters = {
    'n_rc': {
        'type'        : np.int64,
        'default'     : -1,
        'dependencies': ['inters', 'line_reorg',
                         'k_cs', 'n_traps', 'E', 'rates']
        'depends_on'  : None,
        'array'       : False,
        'bounds'      : [1, 10],
        'mutable'     : True,
    ...
    'inters': {
        ...
        'depends_on'  : ['n_rc'],
        'array'       : True,
        'size'        : lambda g: getattr(g, "n_rc") - 1,
        'bounds'      : [-1., 1.],
        'mutable'     : True,
        'norm'        : None,
    },
    ...
    'E': {
        ...
        'array'       : True,
        'dependencies': None,
        'depends_on'  : ['n_traps', 'n_rc'],
        'size'        : lambda g: (getattr(g, "n_rc"),
                                   np.max(getattr(g, "n_traps"))),
        'bounds'      : [-1., 1.],
        'mutable'     : True,
        'norm'        : None,
    },
